...
function initDB() {
  db.serialize(() => {
    ...
    const ensureDefaults = {
      ...
      // Pricing cards — fully editable Plan section
      pricing_card1_name: "Starter",
      pricing_card1_price: "₦80k",
      pricing_card1_suffix: "one-time",
      pricing_card1_desc: "Perfect for first-time sellers",
      pricing_card1_features: "Premium Shopify store\n5 winning products\nPayment & shipping setup\n7-day delivery\n14-day support",
      pricing_card1_btn: "Get Started",
      pricing_card1_badge: "",
      pricing_card2_name: "Growth",
      pricing_card2_price: "₦150k",
      pricing_card2_suffix: "one-time",
      pricing_card2_desc: "For serious entrepreneurs",
      pricing_card2_features: "Everything in Starter\n10 winning products\nAd creatives included\nCopywriting & SEO\n30-day support + training",
      pricing_card2_btn: "Get Started",
      pricing_card2_badge: "MOST POPULAR",
      pricing_card3_name: "Empire",
      pricing_card3_price: "Custom",
      pricing_card3_suffix: "quote",
      pricing_card3_desc: "Scale to six figures",
      pricing_card3_features: "Everything in Growth\nUnlimited products\nSupplier sourcing\nAds management (30 days)\nPriority support",
      pricing_card3_btn: "Contact Us",
      pricing_card3_badge: "",
    };
